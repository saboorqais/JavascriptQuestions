...
function getDataUsingCallbacks(url : string, callback :CallBack) {
    ...
    fetch(url).then((response :Response) => response.json() as Promise<UserDataObject[]>)
 ...
 getDataUsingCallbacks("https://jsonplaceholder.typicode.com/users", (data :UserDataList) :PhoneList => {
...
getDataUsingPromise("https://jsonplaceholder.typicode.com/users").then((data :UserDataList)=>{
    console.log(getPhoneNumbers(data))
}) 
