...
function checkMatch<T, T2>(obj: T | string, querys: T2, query: string): boolean {
    if (typeof obj === "object" && obj !== null && !obj.hasOwnProperty(query)) {
        ...
        return typeof valueToSearchFrom === "string" ? valueToSearchFrom.includes(valueToFind) : false;
    }
}
